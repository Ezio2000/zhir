...
// Live example: MINIMAX_API_KEY=... cargo run -p zhir-minimax --example minimax_tts
use std::sync::Arc;
use zhir::resource::MediaReceiver;
use zhir::{RunRequest, Runtime, message::Message, run::RunMode, stores::MemoryResourceStore};
